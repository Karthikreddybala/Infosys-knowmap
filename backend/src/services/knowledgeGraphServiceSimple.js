/**
 * Simple Knowledge Graph Service (Fallback)
 * 
 * This is a simplified version that doesn't require async initialization
 * and provides immediate functionality even without Python.
 */
...
class SimpleKnowledgeGraphService {
    ...
    async processText(text) {
        ...
        try {
            ...
            // The Python script returns { success, message, data }.
            // Normalize it so frontend always receives graph payload at result.data.
...
export default new SimpleKnowledgeGraphService();
